...
export default function RoverCard({ rover, onclick }: IroverCard) {
  return (
    <li
      onClick={onclick}
      className="hover:bg-slate-900 bg-slate-800 list-none cursor-pointer border-solid border-2 border-blue-700 hover:border-red-600 rounded p-4 font-bold transition-all ">
